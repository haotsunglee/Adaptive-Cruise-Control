...
MODEL                = Final_project_template
MODULES              = Final_project_template_data.c fcan0_s32k_rx_isr.c ftm0_pwm_params.c ftm2_qd_params_config.c ftm3_pwm_params.c mbd_main.c path_data.c adc_driver.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c flexcan_driver.c flexcan_hw_access.c flexcan_irq.c ftm_chn_irq.c ftm_common.c ftm_fault_irq.c ftm_hw_access.c ftm_ic_driver.c ftm_mc_driver.c ftm_oc_driver.c ftm_pwm_driver.c ftm_qd_driver.c interrupt_manager.c lin_common.c lin_driver.c lin_irq.c lin_lpuart_driver.c lpit_driver.c lpuart_driver.c lpuart_hw_access.c lpuart_irq.c mbd_adc_irq.c osif_baremetal.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c Pick_lead_wrapper.c bicycle_model_wrapper.c calc_us_wrapper.c
MAKEFILE             = Final_project_template.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2020a
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2020a
START_DIR            = N:\Final_Project\Project_Files
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 3
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\Final_project_template_mbd_rtw \
...
###################################
%.o : N:\ProblemSet7\Project_Files/%.c
	@echo ### "N:\ProblemSet7\Project_Files\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
...
%.o : C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\gpio/%.c
	@echo ### "C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\gpio\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
...
%.o : C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\ftm/%.c
	@echo ### "C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\ftm\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\adc/%.c
	@echo ### "C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\adc\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\fcan/%.c
	@echo ### "C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\fcan\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\lpuart/%.c
	@echo ### "C:\MATLAB\Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx\mbdtbx_s32k\blocks\lpuart\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
