 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Apr 13 18:03:09 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Pick_lead
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            2
/* Input Port  0 */
#define IN_PORT_0_NAME        s
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       lead_us
...
{
    const real32_T *s = (real32_T *) ssGetInputPortRealSignal(S, 0);
    const real32_T *us = (real32_T *) ssGetInputPortRealSignal(S, 1);
    real32_T *lead_s = (real32_T *) ssGetOutputPortRealSignal(S, 0);
    real32_T *lead_us = (real32_T *) ssGetOutputPortRealSignal(S, 1);

    Pick_lead_Outputs_wrapper(s, us, lead_s, lead_us);
