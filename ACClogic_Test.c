 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Apr 08 16:34:08 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ACClogic_Test
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ACClogic_Test_Outputs_wrapper(const boolean_T *en,
			const real32_T *s,
			const real32_T *u,
			const real32_T *H,
			boolean_T *en_vel,
...
{
    const boolean_T *en = (boolean_T *) ssGetInputPortRealSignal(S, 0);
    const real32_T *s = (real32_T *) ssGetInputPortRealSignal(S, 1);
    const real32_T *u = (real32_T *) ssGetInputPortRealSignal(S, 2);
    const real32_T *H = (real32_T *) ssGetInputPortRealSignal(S, 3);
    ...
    ACClogic_Test_Outputs_wrapper(en, s, u, H, en_vel, en_pos, lead_s, lead_us);
