 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Apr 12 18:32:20 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PickLeadFunction
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            2
/* Input Port  0 */
#define IN_PORT_0_NAME        Scar
...
extern void PickLeadFunction_Outputs_wrapper(const real32_T *Scar,
...
{
    const real32_T *Scar = (real32_T *) ssGetInputPortRealSignal(S, 0);
    const real32_T *UScar = (real32_T *) ssGetInputPortRealSignal(S, 1);
    real32_T *Ls = (real32_T *) ssGetOutputPortRealSignal(S, 0);
    real32_T *Lus = (real32_T *) ssGetOutputPortRealSignal(S, 1);

    PickLeadFunction_Outputs_wrapper(Scar, UScar, Ls, Lus);
