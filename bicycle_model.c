 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Apr 06 19:47:18 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME bicycle_model
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real32_T *delta = (real32_T *) ssGetInputPortRealSignal(S, 1);
    const real32_T *psi = (real32_T *) ssGetInputPortRealSignal(S, 2);
    const real32_T *L1 = (real32_T *) ssGetInputPortRealSignal(S, 3);
    const real32_T *L2 = (real32_T *) ssGetInputPortRealSignal(S, 4);
    ...
    bicycle_model_Outputs_wrapper(u, delta, psi, L1, L2, x_dot, y_dot, psi_dot);
