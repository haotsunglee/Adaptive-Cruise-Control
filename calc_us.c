 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Apr 06 19:47:54 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME calc_us
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        fx
...
{
    const real32_T *fx = (real32_T *) ssGetInputPortRealSignal(S, 0);
    const real32_T *fy = (real32_T *) ssGetInputPortRealSignal(S, 1);
    const real32_T *u = (real32_T *) ssGetInputPortRealSignal(S, 2);
    const real32_T *delta = (real32_T *) ssGetInputPortRealSignal(S, 3);
    const real32_T *psi = (real32_T *) ssGetInputPortRealSignal(S, 4);
    real32_T *us = (real32_T *) ssGetOutputPortRealSignal(S, 0);

    calc_us_Outputs_wrapper(fx, fy, u, delta, psi, us);
